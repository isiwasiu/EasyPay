...
namespace NibbssNPSPaymentStack.API.Controllers
{
    ...
    public class NPSAdminController : ControllerBase // Changed from Controller to ControllerBase
    {
        ...
        public NPSAdminController(
            INibssNPSPayments npsPayment,
            ILogger<NPSAdminController> logger,
        ...
        [HttpGet("AllEndpoints")] // Changed from HttpPost to HttpGet
        ...
        [HttpPatch("UpdateLastAccessed/{id}")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
