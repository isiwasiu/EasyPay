...
namespace NibbssNPSPaymentStack.API.Controllers
{
    [Route("")]
    [ApiController]
    public class EasyInwardController : ControllerBase
    {
        private readonly INibssNPSPayments _npsPayment;
        private readonly ILogger<EasyInwardController> _logger;
        public EasyInwardController(ILogger<EasyInwardController> logger, INibssNPSPayments npsPayment)
        {
            _logger = logger;
        ...
        [AllowAnonymous]
        public async Task<ActionResult> pain008()
        {
